import { Map, Robot, Control, Measurement } from 'app';

// declare this to use d3 since it is loaded directly in the HTML
declare var d3: any;


export class LocalizationAlgoritm {
    private mapProbabilities: Array<number>;

    constructor(private map: Map, private robot: Robot) {
        this.map = map;
        this.robot = robot;
...
export function normalize(data: Array<number>) {
